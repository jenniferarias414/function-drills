...
//   // const numA = Number(num)
//   // const numB = Number(mun2)
//   return num + num2
// }

// let sum = add('four', 9) //turns string to a number??
// console.log(sum)
...
function add(num, num2) {
  num = +num
  num2 = +num2 //(+touching turns it into an integer)
  return num + num2
}
...
// console.log('expression') <----- ANSWER (has =...Equals/Expression)
...
let nameGreeting = nameCheck('Jenny')
...
//CODE HERE
function printAllNames(names) { //parameter (ref point, can be named anything)
  for (let i = 0; i < names.length; i++) {
    console.log(names[i])
  }
}

//why are we using 'names' and not 'namesArr'?

printAllNames(namesArr) //arguemnet -very specific
...
console.log(bestMovie('Point Break'))
